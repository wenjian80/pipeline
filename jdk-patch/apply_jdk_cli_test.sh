...
#
# To apply jdk patch:
# This requires passing jdk bundle location in tar.gz format
#
# /u01/shared/scripts/pipeline/jdk-patch/apply_jdk_cli_test.sh -p <ocir_auth_token> -j <jdk tar.gz bundle location>
#
